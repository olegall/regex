...
namespace ConsoleApp1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var false3 = RegularExpression.UseRegex("a"); // floatRange
            var false4 = RegularExpression.UseRegex("a1"); // floatRange
            ...
            var comma_true_3 = RegularExpression.UseRegex("10,0"); // floatRange
            var comma_false_1 = RegularExpression.UseRegex("00,0"); // floatRange
            var comma_false_2 = RegularExpression.UseRegex("10,1"); // floatRange
            ...
            var decimal_false_1 = RegularExpression.UseRegex("20"); // floatRange
            var decimal_false_2 = RegularExpression.UseRegex("50"); // floatRange
            var decimal_false_3 = RegularExpression.UseRegex("100"); // floatRange
